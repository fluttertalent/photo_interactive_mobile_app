    ...
    <body class="antialiased">
        ...
        <header id="header" class="header d-flex align-items-center fixed-top">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a href="/welcome/{{$user->id}}" class="active">Home</a></li>
                    <li><a href="/">Dashboard</a></li>
                    <li><a href="/about/{{$user->id}}">About</a></li>               
                    <li><a href="/contact/{{$user->id}}">Contact</a></li>
                </ul>
            </nav><!-- .navbar -->
        ...
        <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center" data-aos="fade" data-aos-delay="1500">
            ...
            <div class="row justify-content-center">
                ...
                <h2>I'm <span>{{$user->name}}</span>{{$user->title}}</h2>
                <p>{{$user->bio}}</p>
                <a href="/contact/{{$user->id}}" class="btn-get-started">Available for hire</a>
                </div>
            </div>
            </div>
