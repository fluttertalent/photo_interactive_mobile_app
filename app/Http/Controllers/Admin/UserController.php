...
class UserController extends AdminController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            // Avatar Upload
            if ($request->hasFile('avatar')) {
                if(!in_array($user->avatar, ['boy.png', 'boy-1.png', 'girl.png', 'girl-1.png', 'girl-2.png','man.png', 'man-1.png', 'man-2.png', 'man-3.png', 'empty.jpeg'])){
        ...
        if ($user->id !== 1) {
            if ($user->id !== Auth::user()->id) {
                ...
                if ($user->delete()) {
                    ...
                    Session::flash('flash_title', 'Success');
                    Session::flash('flash_message', 'Sorry, user could not be deleted.');
                }
            } else {
                Session::flash('flash_title', 'Success');
                Session::flash('flash_message', 'Sorry, you cannot delete yourself.');
            }
        } else{
            Session::flash('flash_title', 'Success');
            Session::flash('flash_message', 'Sorry, you can not delete the first user.');
        }
